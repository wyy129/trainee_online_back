...
import com.example.trainee_online_back.constant.BusinessStatus;
import com.example.trainee_online_back.constant.HttpMethod;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            // 获取当前的用户
            String userId = RequestUtil.userId.get().toString();
            // *========数据库日志=========*//
